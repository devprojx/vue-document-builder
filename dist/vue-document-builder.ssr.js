'use strict';var grapesjs=require('grapesjs');require('grapesjs/dist/css/grapes.min.css');function _interopDefaultLegacy(e){return e&&typeof e==='object'&&'default'in e?e:{'default':e}}var grapesjs__default=/*#__PURE__*/_interopDefaultLegacy(grapesjs);function ownKeys(object, enumerableOnly) {
...
var script = {
  ...
  watch: {
    blocks: function blocks(values) {
      ...
      values.forEach(function (el) {
        return _this.editor.BlockManager.add(el.id, _objectSpread2({}, el));
      });
    }
  },
  data: function data() {
  ...
  mounted: function mounted() {
    ...
    this.editor = grapesjs__default["default"].init(_objectSpread2(_objectSpread2({}, this.options), {}, {
      container: "#gjs"
    }));
    window.addEventListener("gjs-save-doc", function (evt) {
      _this2.$emit("save", evt.detail);
    });
  }
...
var __vue_module_identifier__ = "data-v-199e6c96";
/* functional template */
